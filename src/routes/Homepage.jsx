	...
	return (
		<>
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
				<p className="mx-auto -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">Welcome to</p>
				...
				<h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
					...
					<span className="inline-block ml-2"> Financial</span>
					<span className="inline-block"> Advisor</span>
				</h1>
				...
				<img
					...
					alt=""
				/>
				<p className="mx-auto mt-0 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
					<span className="inline-block">
